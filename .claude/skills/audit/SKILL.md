...
- Apps (RollHook-managed, auto-suffixed names like `argo-argo-api-146` — match by label, not name): `argo-api`, `argo-dashboard`, `audio-gateway`, `basalt-ui-marketing`, `bun-email-api`, `image-gen-gateway`, `imgproxy`, `weatherorb-edge`, `photo-gallery`, `rollhook-marketing`
