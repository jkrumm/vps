...
| Internal | `:4319` (http) | none | docker `monitoring-net` membership | Traefik, argo-api, imgproxy, audio-gateway, image-gen-gateway, weatherorb-edge, fpp-server, fpp-analytics, rollhook |
